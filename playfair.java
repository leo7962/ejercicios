 ...
 public String arreglar(String texto){
  ...
  for(int i = 0; i<texto2.length();i++){
   ...
   if(texto2.charAt(i)!=texto2.charAt(i+1)){
    arreglado = arreglado + texto2.charAt(i) + texto2.charAt(i+1); //Compruebo que no haya digramas igules
    i++;
   }
   else{
    arreglado = arreglado + texto2.charAt(i) + 'Z';  //Si los hay meto x entre medio
   }
   }
   else
    arreglado = arreglado + texto2.charAt(i) + 'Z';  //Si la longitud del texto es impar incluyo una X
